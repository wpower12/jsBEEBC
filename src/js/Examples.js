...
export let CountSub2 = [ 
	...
	0b01110100, // [02] JC  [4]  - If Carry, Jump to 4 (Start of sub loop)
	0b01100000, // [03] J   [0]  - Else,     Jump to 0 (Start of add loop)
	0b00111111, // [04] SUB [15] - Load from memory at 15 (2) into B, put A-B in A
	0b11100000, // [05] OUT      - Put A in OR, and Display
	0b10000000, // [06]	JZ  [0]  - If Zero,  Jump to 0 (Start of add loop)
	0b01100100, // [07] J   [4]  - Else,     Jump to 4 (Start of sub loop)
	0b00000000, // [08]
	0b00000000, // [09]
	0b00000000, // [10]			 	 
	0b00000000, // [11]
